...
import com.example.finalproject.ui.settings.SettingsFragment;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        buttonAddressBook.setOnClickListener(v -> {
            ...
            requireActivity().getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.nav_host_fragment_content_main, new com.example.finalproject.ui.address.AddressBookFragment())
                    .addToBackStack(null)
                    .commit();
        });
        ...
        buttonNotifications.setOnClickListener(v -> {
            ...
            requireActivity().getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.nav_host_fragment_content_main, new com.example.finalproject.ui.notifications.NotificationsFragment())
                    .addToBackStack(null)
                    .commit();
        });
